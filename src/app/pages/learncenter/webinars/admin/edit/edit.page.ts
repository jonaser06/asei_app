...
export class EditPage implements OnInit {
  ...
  add_image(e){
    ...
    this.learncenterService.add_capacitador(formdata, 'webinnars', id)
    .then(resp=>{
      console.log(resp);
    });
  ...
  add_sesion(event){
    ...
    this.learncenterService.add_sesion(formdata, 'webinnars', id)
    .then(resp=>{
      console.log(resp);
    });
  ...
  add_course(){
    ...
    this.learncenterService.update_webinnars('webinnars', id, formdata)
    .then(resp=>{
